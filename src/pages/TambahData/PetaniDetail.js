    ...
    Alert.alert(
      ...
      [
        {text: 'Batal', style: 'cancel'},
        {
          ...
          onPress: async () => {
            getData('transaksi').then(res => {
              let filted = res.filter(
                i => i.id_petani !== route.params.id_petani,
              );
              console.log(filted);
    ...
    <View style={{flex: 1, backgroundColor: colors.white}}>
          ...
          renderItem={({item, index}) => {
            return (
              <View
                ...
                {item.tipe !== 'Poin' && (
                  <MyList label="Poin" value={item.poinku ?? 0} />
                )}
                <MyList
      ...
      <View style={{paddingHorizontal: 10, backgroundColor: 'white'}}>
        ...
        <View
          ...
          <Text
            ...
            {'Rp' + new Intl.NumberFormat('id-ID').format(TOTAL.pemasukan)}
          </Text>
        </View>
      </View>
      ...
      <View style={{paddingHorizontal: 10, backgroundColor: 'white'}}>
        ...
        <MyButton
          onPress={deleteAll}
          warna={colors.danger}
          title="Hapus Semua Transaksi Petani ini"
        />
      </View>
